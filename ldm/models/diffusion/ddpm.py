...
from diffusers import AutoencoderKL, DDPMScheduler, UNet2DConditionModel, LCMScheduler
...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
        ...
        super().__init__(conditioning_key=conditioning_key, K=K, *args, **kwargs)
...
class DiffusionWrapper(pl.LightningModule):
    def __init__(self, diff_model_config, conditioning_key):
        ...
        self.diffusion_model = UNet2DConditionModel.from_pretrained(pretrained_model_name_or_path, subfolder="unet")
